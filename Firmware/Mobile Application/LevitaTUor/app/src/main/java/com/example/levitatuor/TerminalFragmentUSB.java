...
public class TerminalFragmentUSB extends Fragment implements ServiceConnection, SerialListener {
    ...
    private SpannableStringBuilder buttonBuffer;

    public TerminalFragmentUSB() {
        ...
        buttonBuffer = new SpannableStringBuilder();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        receiveText = view.findViewById(R.id.serial_monitor_in);            // TextView performance decreases with number of spans
        receiveText.setTextColor(getResources().getColor(R.color.colorRecieveText)); // set as default color to reduce number of spans
        receiveText.setMovementMethod(ScrollingMovementMethod.getInstance());

        sendText = view.findViewById(R.id.insertFreeText);
        sendBtn = view.findViewById(R.id.sendSerialLine);
        hexWatcher = new TextUtil.HexWatcher(sendText);
        hexWatcher.enable(hexEnabled);
        sendText.addTextChangedListener(hexWatcher);
        sendText.setHint(hexEnabled ? "HEX mode" : "");

        View sendBtn = view.findViewById(R.id.sendSerialLine);
...
*/
    ...
    */
    ...
    public void send(String str) {
        //receiveText = requireActivity().findViewById(R.id.serial_monitor_in);
    ...
    private void receive(ArrayDeque<byte[]> datas) {
        ...
        if (activity != null) receiveText = activity.findViewById(R.id.serial_monitor_in);
        if(receiveText != null) {
            SpannableStringBuilder spn = new SpannableStringBuilder();
    ...
    public SpannableStringBuilder getButtonBuffer(){
        return  buttonBuffer;
    }
